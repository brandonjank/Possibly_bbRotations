...
-- COMBAT ROTATION
	...
	-- THREAT ROTATION
	{ "Savage Defense", { "modifier.cooldowns", "player.rage >= 60", "target.distance < 5", "target.agro", "!player.buff(Savage Defense)", "player.health <= 80" } },
	...
	{ "Barkskin", { "player.health < 90", "target.agro", "target.distance < 5" } },
	...
	{ "Heart of the Wild", { "modifier.cooldowns", "player.health < 95", "target.agro", "target.distance < 5" } },
	{ "Rejuvenation", { "player.buff(Heart of the Wild)", "player.buff(Heart of the Wild).remains <= 4" } },
	{ "Nature's Vigil", { "modifier.cooldowns", "player.health < 95", "target.agro", "target.distance < 5" } },
	...
	{ "Incarnation: Son of Ursoc", { "modifier.cooldowns", "player.health < 70", "target.agro", "target.distance < 5" } },
