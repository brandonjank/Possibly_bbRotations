...
function bbLib.bossMods()
	...
	if UnitExists("target") and (UnitAura("target", "Reckless Provocation") -- Iron Docks - Fleshrender
		or UnitAura("target", "Sanguine Sphere")) then -- Iron Docks - Enforcers
			SpellStopCasting()
			--StopAttack()
			return true
	end

	if UnitAura("player", "Food")
